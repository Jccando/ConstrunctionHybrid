"""Publication-grade figures (no title, numbered Fig3-10, multi-panel (a)(b)(c) corner labels). CSV-based figures (no training needed).
Fig3 main comparison / Fig5 heatmap / Fig6 CD / Fig8 RAG ablation / Fig9 component ablation / Fig10 SHAP drivers.
"""
import sys, warnings
...
# ---- Fig.3 main comparison (3 panels, no title) ----
def fig3():
...
# ---- Fig.5 cross-dataset heatmap (no title) ----
def fig5():
...
# ---- Fig.8 RAG knowledge ablation (no title) ----
def fig8():
...
# ---- Fig.9 component ablation (no title) ----
def fig9():
...
# ---- Fig.10 SHAP drivers (2 panels, no title) ----
def fig10():
