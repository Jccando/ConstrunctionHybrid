"""Publication-grade figures (no title, numbered): Fig4 predicted-vs-actual parity / Fig7 multi-seed stability violin.
Requires training (proposed Stacking / individual models). Multi-panel (a)(b)(c) corner labels, no title.
"""
import sys, warnings
...
FIG = ROOT / "code" / "experimentresult" / "figures"
...
def main():
    print("generating Fig4 / Fig7 (no title, numbered)...", flush=True)
