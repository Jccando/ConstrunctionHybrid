"""Supplementary experiments: (1) uncertainty analysis (NGBoost interval coverage/width)
(2) SHAP dependence plot (marginal effect of Duration)
"""
import sys, warnings
...
TAB = ROOT / "code" / "experimentresult" / "tables"
...
def uncertainty_analysis():
    """NGBoost 90% interval: coverage + interval width + calibration"""
    results = []
