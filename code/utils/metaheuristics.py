"""Lightweight metaheuristic optimizers (pure numpy, no external dependencies).
- pso: particle swarm, used to search SVR hyperparameters (C, gamma, epsilon) in log space.
- ga:  real-coded genetic algorithm, used to search ANN hyperparameters (hidden, alpha, lr).
Both minimize the objective f(x)."""
import numpy as np
